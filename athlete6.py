class Athlete:
	...
	def athleteWorldrecord(self, worldrecord,  game):
	 if game == "M100":	        
               if   self.get_score()== worldrecord: 
                 print ("Performance equal to worldrecord")
               if   self.get_score()> worldrecord: 
                 print ("made a new world record")
               if   self.get_score()< worldrecord: 
                 print ("performance worse than the world record") 
	 
	 
	 
	 if game == "TRIPLE JUMP":	        
               if   self.get_score()== worldrecord: 
                 print ("Our athlete's performance is equal to worldrecord")
               if   self.get_score()> worldrecord: 
                 print ("Our athlete made a new world record")
               if   self.get_score()< worldrecord: 
                 print ("Our athlete's performance is  worse than the world record")
...
a2 =Athlete("Jones","01/08/1962", "TRIPLE JUMP",2,2,3)
a2.__str__()                 
...
print("-----------------------------------------------------------")
print ("Call method athleteScoreRecordLimit  to check if our athlete (a2) can participate in TRIPLE JUMP")  
              
                
a2.athleteScoreRecordLimit(1.50,"TRIPLE JUMP")
print ("Call method athleteWorldrecord to check if our athlete (a2) broke  the world record in TRIPLE JUMP")

a2.athleteWorldrecord( 2,"TRIPLE JUMP"  )
